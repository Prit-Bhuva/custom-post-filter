...
if (!function_exists('post_filter_form_shortcode')) {
    /**
     * Generate the shortcode for the post filter form.
     *
     * @return string The generated shortcode.
     */
    function post_filter_form_shortcode(): string
    {
                    ...
                    <div class="filter-post">
                        ...
                        <div class="posts">
                            ...
                            while ($query->have_posts()) : $query->the_post();
                                ...
                                $featured_image = get_the_post_thumbnail_url(get_the_ID(), 'full'); // Get post featured image
                                $featured_image = $featured_image ? $featured_image : plugin_dir_url(__FILE__) . '../assets/images/placeholder-image.png';
                            ...
                            ?>
                                <div class="post-box">
                                    <div class="ft-image">
                                        <a href="<?php echo $post_link; ?>"><img src="<?php echo $featured_image; ?>" alt="<?php echo $post_title; ?> featured image"></a>
                                    </div>
                                    <div class="post-info">
